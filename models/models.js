...
sequelize.sync().then(function(){
  ...
  Cuento.count().then(function (count){
       if (count < 3){
        Cuento.create({titulo: "El Soldadito de plomo" , cuento: "Éranse una vez veinticinco soldados de plomo,"
                     });                    
        Cuento.create({titulo: "Los tres cerditos" , cuento: "En el corazón del bosque vivían tres cerditos que eran"
                     });
        Cuento.create({titulo: "El libro de la Selva" , cuento: "Este es el cuento de un niño a quien Ba"
                     })
